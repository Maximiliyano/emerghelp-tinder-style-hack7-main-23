<template>
  <v-container fluid>
    <v-row>
      <v-col cols="12" md="6" lg="4" v-for="(data) in requests" v-bind:key="data.id">
        <v-card class="w100" :key="data.id" tile>
                    <v-card tile>
                      <v-img
                        v-if="!data.flipped"
                      ...
                      >
                        <v-card-title class="pb-2">{{ data.title }}</v-card-title>

                        <v-card-text>
                          <v-chip
                            class="mb-4 mr-1"
                            v-for="i in data.category"
                            :key="i"
                            >{{ i }}</v-chip
                          >
                  ...
                  <v-btn fab @click="data.flipped = !data.flipped"
                ...
                >
                      ...
                      <div v-else class="h75">
                        ...
                        <v-card-text v-if="data.social.length" class="d-flex my-0 py-0 justify-start">
                          <a href="http://t.me/romnnko" v-if="data.social.telegram">
                            <v-btn
                              color="blue"
                              icon
                              dark
                          ...
                          <a :href="data.social.other" v-if="data.social.other">
                            <v-btn
                              color="grey"
                              icon
                              dark
                ...
                <v-col cols="12">
                  <v-select
                label="Статус"
                :items="['Готовий узяти', 'В роботі', 'Виконано']"
                outlined
                hide-details
              />
                </v-col>
...
export default {
  ...
  methods: {
    ...
    getProducts: async function () {
      ...
      try {
        const list = []
        const newSource = await getRequests()
